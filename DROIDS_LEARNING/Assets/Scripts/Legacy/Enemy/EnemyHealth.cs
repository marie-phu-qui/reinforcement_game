...
public class EnemyHealth : MonoBehaviour
{
    ...
    public int unitCriticalDamageLevel;             
    public int unitPointsValue;
    public bool damageCritical = false;             
    ...
    void Start()
    {
        ...
        if (isTurret == true)
        {
            ...
            unitPointsValue = turretPointsValue;
        }
        ...
        if (isSoldier == true)
        {
            ...
            unitPointsValue = soldierPointsValue;
        }
    }
    ...
    public void TakeDamage(int damage)
    {
        ...
        if (unitHealth <= 0)
        {
            ...
            GetComponent<EnemyDeath>().HandleDeath(unitPointsValue);
        }
    }
}